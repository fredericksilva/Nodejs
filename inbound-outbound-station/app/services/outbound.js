...
class OutboundService {
     ...
     * @param logger
     */
    constructor(catalogClient, outbound, config, paginator, logger) {
        this.logger = logger;
        this.config = config;
    ...
    fetchBatches(params) {
        ...
        return this.outbound.getBatches(params).then((resp) => {
    ...
    /**
     * get Outbound details for a batch number
     *
     * @param batchNo
     * @return {*}
     */
    fetchBatch(batchNo) {
        ...
        return this.outbound.getBatch(batchNo).then((resp) => {
